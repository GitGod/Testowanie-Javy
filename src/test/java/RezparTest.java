...
public class RezparTest extends BazeTest {
    ...
    public static Iterable<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
                {new Rezerwacja(LocalDate.of(2022, 1, 17), "12.30", "14", s1), false},
                {new Rezerwacja(LocalDate.of(2022, 1, 17), "12", "14", s2), true},
                {new Rezerwacja(LocalDate.of(2022, 1, 17), "15", "16", s1), true},
                {new Rezerwacja(LocalDate.of(2022, 1, 17), "15", "16", s2), true},
        });
    }
    ...
    public void setUp() throws IOException, MessagingException {
        ...
        rezerwacje.dodajRezerwacje(new Osoba("Kamil", "a@o2.pl"), new Rezerwacja(LocalDate.of(2022, 1, 17), "12", "14", s1), restauracja);
    }
